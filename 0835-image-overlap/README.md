...
<pre style="position: relative;"><strong>Input:</strong> img1 = [[1,1,0],[0,1,0],[0,1,0]], img2 = [[0,0,0],[0,1,1],[0,0,1]]
...
<pre style="position: relative;"><strong>Input:</strong> img1 = [[1]], img2 = [[1]]
<strong>Output:</strong> 1
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> img1 = [[0]], img2 = [[0]]
