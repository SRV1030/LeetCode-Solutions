...
<pre style="position: relative;">     Number of Bytes   |        UTF-8 Octet Sequence
                       |              (binary)
   --------------------+-----------------------------------------
            1          |   0xxxxxxx
            2          |   110xxxxx 10xxxxxx
...
<pre style="position: relative;"><strong>Input:</strong> data = [197,130,1]
...
<pre style="position: relative;"><strong>Input:</strong> data = [235,140,4]
