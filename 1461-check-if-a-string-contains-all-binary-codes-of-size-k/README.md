...
<pre style="position: relative;"><strong>Input:</strong> s = "00110110", k = 2
...
<pre style="position: relative;"><strong>Input:</strong> s = "0110", k = 1
<strong>Output:</strong> true
...
<pre style="position: relative;"><strong>Input:</strong> s = "0110", k = 2
