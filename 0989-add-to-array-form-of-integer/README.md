...
<pre style="position: relative;"><strong>Input:</strong> num = [1,2,0,0], k = 34
...
<pre style="position: relative;"><strong>Input:</strong> num = [2,7,4], k = 181
...
<pre style="position: relative;"><strong>Input:</strong> num = [2,1,5], k = 806
