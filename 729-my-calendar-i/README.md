...
myCalendar.book(20, 30); // return True, The event can be booked, as the first event takes every time less than 20, but not including 20.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
