...
<pre style="position: relative;"><strong>Input:</strong> bombs = [[2,1,3],[6,1,4]]
...
<pre style="position: relative;"><strong>Input:</strong> bombs = [[1,1,5],[10,10,5]]
...
<pre style="position: relative;"><strong>Input:</strong> bombs = [[1,2,3],[2,3,1],[3,4,2],[4,5,3],[5,6,4]]
