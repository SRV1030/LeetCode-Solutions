...
<pre style="position: relative;"><strong>Input:</strong> plantTime = [1,4,3], growTime = [2,3,1]
...
<pre style="position: relative;"><strong>Input:</strong> plantTime = [1,2,3,2], growTime = [2,1,2,1]
<strong>Output:</strong> 9
<strong>Explanation:</strong> The grayed out pots represent planting days, colored pots represent growing days, and the flower represents the day it blooms.
One optimal way is:
...
<pre style="position: relative;"><strong>Input:</strong> plantTime = [1], growTime = [1]
