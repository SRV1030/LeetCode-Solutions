...
<pre style="position: relative;"><strong>Input:</strong> n = 1, headID = 0, manager = [-1], informTime = [0]
...
<pre style="position: relative;"><strong>Input:</strong> n = 6, headID = 2, manager = [2,2,-1,2,2,2], informTime = [0,0,1,0,0,0]
