...
<pre style="position: relative;"><strong>Input:</strong> tokens = [100], power = 50
...
<pre style="position: relative;"><strong>Input:</strong> tokens = [100,200], power = 150
...
<pre style="position: relative;"><strong>Input:</strong> tokens = [100,200,300,400], power = 200
