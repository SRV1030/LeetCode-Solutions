...
<pre style="position: relative;"><strong>Input:</strong> l1 = [2,4,3], l2 = [5,6,4]
...
<pre style="position: relative;"><strong>Input:</strong> l1 = [0], l2 = [0]
<strong>Output:</strong> [0]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> l1 = [9,9,9,9,9,9,9], l2 = [9,9,9,9]
